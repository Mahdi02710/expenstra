...
class WalletsOverview extends StatefulWidget {
  ...
  @override
  State<WalletsOverview> createState() => _WalletsOverviewState();
}

class _WalletsOverviewState extends State<WalletsOverview> {
  bool _mountedAfterFirstFrame = false;

  @override
  void initState() {
    super.initState();
    // Fix overflow after restart by rebuilding once layout is stable
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) setState(() => _mountedAfterFirstFrame = true);
    });
  }
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${((widget.totalDebt / widget.totalBalance) * 100).toStringAsFixed(1)}%',
                            style: AppTextStyles.body2.copyWith(
                              color: AppColors.warning,
                            ),
                          ),
